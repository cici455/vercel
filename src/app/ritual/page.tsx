  ...
  return (
    <div className="min-h-screen bg-black text-white font-serif relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        />
        <motion.div
          className="absolute top-3/4 right-1/3 w-96 h-96 bg-white/15 rounded-full blur-3xl"
          animate={{
            x: [0, -40, 0, 40, 0],
            y: [0, 30, -10, 30, 0],
        ...
        />
        <motion.div
          className="absolute top-1/2 left-1/3 w-64 h-64 bg-white/18 rounded-full blur-3xl"
          animate={{
            x: [0, 60, 0, -60, 0],
            y: [0, -30, 15, -30, 0],
